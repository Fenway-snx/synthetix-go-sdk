...
const (
	...
	// DefaultChainID is the chain id used in the domain. The Synthetix
	// API pins this to mainnet (1) regardless of the actual deployment
	// environment because the API verifies the EIP-712 signature.
	DefaultChainID = 1

	// ZeroAddress is the verifyingContract value used in the
	// domain separator. The API does not have a verifying contract.
